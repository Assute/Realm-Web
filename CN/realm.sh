...
UPDATE_URL="https://ghfast.top/https://raw.githubusercontent.com/Assute/Realm-Web/main/realm.sh"
VERSION_CHECK_URL="https://ghfast.top/https://raw.githubusercontent.com/Assute/Realm-Web/main/version.txt"
...
main_menu() {
    ...
    echo -e "    仓库：https://github.com/Assute/Realm-Web${NC}"
        echo -e "${YELLOW}▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂﹍▂${NC}"
        echo -e "  "
